    ...
    const workshops = [
        {
            ...
            objective: t('ateliers.workshops.0.objective', 'Décrypter les dynamiques des marchés du café et du cacao au Canada pour mieux s\'y positionner.'),
            content: t('ateliers.workshops.0.content', { returnObjects: true }),
        ...
        },
        {
            ...
            content: t('ateliers.workshops.1.content', { returnObjects: true }),
        ...
        },
        {
            ...
            objective: t('ateliers.workshops.2.objective', 'Valoriser son café ou cacao pour se distinguer sur un marché concurrentiel.'),
            content: t('ateliers.workshops.2.content', { returnObjects: true }),
            audience: t('ateliers.workshops.2.audience', 'Producteurs, coopératives, PME agro-export, marques locales'),
            color: 'from-amber-800 to-amber-950',
        },
        {
            icon: <Coffee className="h-5 w-5" />,
            title: t('ateliers.workshops.3.title', 'Atelier Goût & Dégustation - L\'Art du Cupping et du Chocolat'),
            objective: t('ateliers.workshops.3.objective', 'Maîtriser les critères sensoriels valorisés au Canada.'),
            content: t('ateliers.workshops.3.content', { returnObjects: true }),
            audience: t('ateliers.workshops.3.audience', 'Producteurs, coopératives, baristas, chocolatiers, transformateurs, acheteurs'),
            color: 'from-amber-600 to-amber-800',
        },
        {
            icon: <Leaf className="h-5 w-5" />,
            title: t('ateliers.workshops.4.title', 'Atelier Technique - Culture, Transformation & Durabilité'),
            objective: t('ateliers.workshops.4.objective', 'Renforcer la qualité et la durabilité des chaînes de valeur café et cacao.'),
            content: t('ateliers.workshops.4.content', { returnObjects: true }),
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <h2 className="text-4xl font-bold text-sicaf-darkCoffee md:text-5xl lg:text-6xl">
                        {t('ateliers.title', 'Les Ateliers du')} <span className="text-amber-700">SICCAF</span>
                    </h2>
                    <motion.div
                        initial={{ width: 0 }}
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
                        {t('ateliers.subtitle', 'Des ateliers pratiques conçus pour outiller les acteurs africains du café et du cacao et les préparer à l\'export vers le marché canadien')}
                    </p>
                </motion.div>
